...
public class Student {
    ...
    private static final HashMap<String, ArrayList<String>> studentModMap = new HashMap<>();
    
    // Static map to keep track of students by class
    private static final Map<String, List<HashMap<String, Object>>> classMap = new HashMap<>();
